...
public class CustomerPage extends JFrame implements ActionListener{
	...
	public CustomerPage(Dashboard dashboard, CustomerList customers){
		super("Super Shop Management System 2023 - Customer Informations");
		this.dashboard = dashboard;
		this.customers = customers;
		initialization();
		
		// customer header
		customerHeader = new JLabel("MANAGE OUR CUTOMERS");
		customerHeader.setBounds(80, 5, 350, 40);
		customerHeader.setFont(boldFont);
		customerHeader.setForeground(blueColor);
		...
		silver.setFont(font);
		silver.setForeground(blueColor);
		silver.setBackground(new Color(240, 245, 245));
		this.add(silver);
		...
		gold.setFont(font);
		gold.setForeground(blueColor);
		gold.setBackground(new Color(240, 245, 245));
		this.add(gold);
		
		platinum = new JRadioButton("Platinum");
		platinum.addActionListener(this);
		platinum.setBounds(500,205,120,25);
		platinum.setFont(font);
		platinum.setForeground(blueColor);
		platinum.setBackground(new Color(240, 245, 245));
		this.add(platinum);
	...
	public void createTable(){
		...
		customerTable.setBackground(new Color(174,247,255));
		customerTable.setSelectionBackground(new Color(200, 200, 230));
