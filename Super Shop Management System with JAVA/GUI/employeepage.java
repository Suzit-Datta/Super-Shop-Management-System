...
public class employeepage extends JFrame implements ActionListener{
	...
	public employeepage(Dashboard dashboard, EmployeeList employees){
		...
		employeeSalaryLabel.setFont(font);
		...
		employeeGenderLabel.setFont(font);
		...
		employeeSalaryText.setFont(font);
		...
		radioButton1.setForeground(blueColor);
		radioButton1.setBackground(new Color(240, 245, 245));
        ...
        radioButton2.setForeground(blueColor);
		radioButton2.setBackground(new Color(240, 245, 245));
	...
	public void initialization(){
		this.setSize(1000, 700); // w 1920, h 1080
