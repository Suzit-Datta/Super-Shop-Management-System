...
public class CartPage extends JFrame implements ActionListener{
	...
	public CartPage(Dashboard dashboard, ProductList products, CustomerList customers){
		super("Super Shop Management System 2023 - Sells Panel");
		...
		// product Header
		productHeader = new JLabel("OUR PRODUCT LISTS");
		productHeader.setBounds(50,5, 300, 40);
		productHeader.setFont(boldFont);
		productHeader.setForeground(blueColor);
		...
		checkBtn.setBackground(blueColor);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(addBtn == e.getSource()){
			...
			//else if(){
			//	JOptionPane.showMessageDialog(this,"Stock Out!!!","Warning",JOptionPane.WARNING_MESSAGE );
			//}
			else{
