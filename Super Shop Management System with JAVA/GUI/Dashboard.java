...
public class Dashboard extends JFrame implements ActionListener{
	...
	public Dashboard(Login loginPage){
		super("Super Shop Management System 2023 - Dashboard");
		...
		sellsBtn.setForeground(Color.WHITE);
		sellsBtn.setBackground(blueColor);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(logoutBtn == e.getSource()){
			int confirmed = JOptionPane.showConfirmDialog(null, "ARE YOU WANT TO LOG OUT?","LOG OUT",JOptionPane.YES_NO_OPTION);
