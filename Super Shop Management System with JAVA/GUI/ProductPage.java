...
public class ProductPage extends JFrame implements ActionListener{
	...
	public ProductPage(Dashboard dashboard, ProductList products){
		super("Super Shop Management System 2023 - Products Informations");
		this.dashboard = dashboard;
		this.products = products;
		initialization();
		
		//============================//
		productmanageLabel = new JLabel("MANAGE OUR PRODUCTS");
		productmanageLabel.setBounds(80,5,350,50);
	    productmanageLabel.setFont(boldFont);
	    productmanageLabel.setForeground(blueColor);
	...
	public void initialization(){
		...
		//ImageIcon image = new ImageIcon("./Assets/productpage.png");
	...
	public void actionPerformed(ActionEvent e){		
		if(addBtn == e.getSource()){
			...
			if(!Id.isEmpty() && !Name.isEmpty() && !Price.isEmpty() && !Quantity.isEmpty()){
				//Product c = new Product(Name,Integer.parseInt(Id),Double.parseDouble(Price),Catagory,Integer.parseInt(Quantity),Drinktype,Double.parseDouble(Netvolume));
				//products.insert(c);
